...
# Se os arquivos estiverem em um subdiretório "DADOS" dentro de "C:\\opasR"
dengue_pr <- import("C:\\opasR\\DADOS\\dengue_pr_2024.csv")

# Para importar um arquivo compactado (zip), verifique se o arquivo contém um CSV ou outro formato suportado pelo pacote 'rio'
pop_pr <- import("C:\\opasR\\DADOS\\populacao_pr_compactado.zip")
